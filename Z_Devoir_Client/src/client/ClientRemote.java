...
public class ClientRemote {
	...
	public static void initFilierDao() throws NamingException {
		filierDao=(IDAO<Filiere>) ctx.lookup("ejb:/Z_Devoir_Server/fs!dao.IDAO");
	...
	public static void initRoleDao() throws NamingException {
		...
		roleDao=(IDAO<Role>) ctx.lookup("ejb:/Z_Devoir_Server/rs!dao.IDAO");
	...
	public static void initStudentDao() throws NamingException {
		...
		studentDao=(IDAO<StudentDto>) ctx.lookup("ejb:/Z_Devoir_Server/ss!dao.IDAO");
	}
